...
export default function BotonInscripcion({
  ...
  const estaInscripto = estadoInscripcion === "CONFIRMADA" || estadoInscripcion === "ASISTIO" || (estadoInscripcion === "PENDIENTE" && !esPago);
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-slate-50 rounded-2xl p-4 space-y-3 border border-slate-100">
                <div>
                  ...
                  <p className="font-bold text-slate-900 select-all">CIRCULO.KINESIO.MZA</p>
                </div>
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">CBU</p>
                  <p className="font-bold text-slate-900 select-all">0110000000000000000000</p>
                </div>
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Titular</p>
                  <p className="font-bold text-slate-900">Círculo Kinesiólogos Mendoza</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <a
                  href={`https://wa.me/5492610000000?text=${encodeURIComponent(whatsappMessage)}`}
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href={`mailto:pagos@ckmendoza.com.ar?subject=${encodeURIComponent(emailSubject)}`}
