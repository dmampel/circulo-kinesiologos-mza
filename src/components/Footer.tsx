      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="pt-16 pb-12 border-b border-slate-800 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          ...
          <div className="flex gap-3">
            <a
              href="https://web.facebook.com/circulo.kinesiologos.mendoza"
              target="_blank"
              rel="noopener noreferrer"
              className="h-9 w-9 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-colors"
            >
            ...
            <a
              href="https://www.instagram.com/circulo.kinesiologos.mendoza"
              target="_blank"
              rel="noopener noreferrer"
              className="h-9 w-9 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-colors"
            >
