    ...
    <div className="flex flex-col">
      ...
      <section className="bg-slate-900 pt-24 pb-40 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
          <div className="absolute top-10 left-10 w-80 h-80 bg-blue-600 rounded-full blur-[130px] opacity-25" />
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-cyan-500 rounded-full blur-[150px] opacity-15" />
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl xl:text-7xl font-black text-white tracking-tighter leading-[1.05] mb-6">
                La casa de la{" "}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 lg:divide-x divide-slate-200">
            {[
              ...
              <div key={title} className="flex flex-col gap-4 px-8 py-6 first:pl-0 last:pr-0 group">
      ...
      {(ultimasNoticias.length > 0 || proximasCapacitaciones.length > 0) && (
        <section className="py-20 bg-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-12 lg:divide-x lg:divide-slate-100">
              ...
              {ultimasNoticias.length > 0 && (
                <div>
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <Link href="/noticias" className="inline-flex items-center text-sm font-bold text-slate-400 hover:text-blue-600 transition-colors mr-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {ultimasNoticias.map((noticia) => (
                      ...
                      >
                        <div className="h-28 overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100">
                          {noticia.imagen_url
                  ...
                  <div className="space-y-3">
                    {proximasCapacitaciones.map((cap) => {
                      ...
                      return (
                        ...
                        >
                          <div className="shrink-0 text-center bg-white border border-slate-200 rounded-xl px-3 py-2 w-14">
                            <p className="text-xs font-bold text-slate-400 uppercase leading-none">
                              {new Date(cap.fechaInicio).toLocaleDateString("es-AR", { month: "short" })}
                            </p>
                            <p className="text-xl font-black text-slate-900 leading-tight">
                              {new Date(cap.fechaInicio).getDate()}
                            </p>
                          </div>
                          <div className="flex-1 min-w-0">
                            ...
                            <h3 className="font-black text-slate-900 text-sm line-clamp-1">{cap.titulo}</h3>
                          </div>
                          {cap.costo
                            ? <p className="shrink-0 text-sm font-black text-slate-700">${Number(cap.costo).toLocaleString("es-AR")}</p>
                            : <p className="shrink-0 text-xs font-black text-emerald-600">Gratuita</p>
                          }
                        </div>
                      );
                    })}
                  </div>
                  <p className="mt-5 text-xs text-slate-400">Asociate para acceder a la agenda completa e inscribirte.</p>
                </div>
              )}
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 gap-4">
              <div>
                ...
                <h2 className="text-3xl font-bold text-white">
                  Beneficios exclusivos<br />para socios
                </h2>
      ...
      {/* ── CTA ───────────────────────────────────────────────── */}
      <section className="bg-white border-t border-slate-100 py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-blue-600 text-xs font-black uppercase tracking-widest mb-6">
            Portal del Socio
          </p>
          <h2 className="text-5xl lg:text-7xl font-black text-slate-900 tracking-tighter leading-[0.95] mb-10 max-w-4xl">
