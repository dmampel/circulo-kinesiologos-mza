...
// Aquí importaríamos la acción de servidor para guardar
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-[2.5rem] p-8 lg:p-10 border border-slate-100 shadow-sm space-y-6">
              <div className="space-y-2">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Título de la Noticia</label>
              ...
              <div className="space-y-2">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Resumen / Bajada</label>
                <textarea 
                  name="resumen"
              ...
              <div className="space-y-2">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest ml-1">Contenido Principal</label>
                ...
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight ml-2">Soporta formato básico y saltos de línea.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white">
              <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 mb-4">Tips de Edición</h4>
